    ...
    $(document).ready(function() {
        ...
        function cargarUsuarios() {
            ...
            usuarios.forEach(function(usuario) {
                tablaUsuarios.append('<tr><td>' + usuario.id + '</td><td>' + usuario.nombre +
                    '</td><td>' + usuario.apellido + '</td><td>' + usuario.nivel +
                    '</td><td><button class="btn btn-primary btn-sm editarUsuario" data-id="' +
                    usuario.id +
                    '">Editar</button> <button class="btn btn-danger btn-sm eliminarUsuario" data-id="' +
                    usuario.id + '">Eliminar</button></td></tr>');
            });
        }
        cargarUsuarios();
